...
public static class Mage extends Main.Person {
    public class Mage extends Main.Person {
        int health = 100;
        int protection = 15;
        Mage(String name) {
            super(name);
...
public class Archer extends Main.Person {
    int health = 120;
    int protection = 12;
    Archer(String name) {
        super(name);
   ...
   */
    public static void main(String[] args) throws Exception {
        ...
        Main.Person person = new Main.Person(PERSON_NAME);
        ...
        test("Mage: наследуется от Person", mage instanceof Main.Person);
        ...
        test("Archer: Наследуется от Person", archer instanceof Main.Person);
